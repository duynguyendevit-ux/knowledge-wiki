---
title: Fireworks Rack Sizes & Tube Specifications - Deep Reference
tags: [fireworks, 3d-modeling, game-design, technical-specs]
date: 2026-06-07
---
...
- **Layout:** Two rows, fanned outward
- **Fan angle:** ~15° off center (each outer row)
- **Price point:** ~$42.99 (2024 retail)
- **Use:** Wider spread pattern

#### 15-Shot Rack
- **Tubes:** 15× DR11 12" tubes
- **Layout:** Can be straight or fan
- **Use:** Medium displays
...
#### 6-Shot ARC Sleeve
- **Length:** 17.5" (44.5 cm)
- **Width:** ~3" (7.6 cm) internal
- **Tubes:** 6× DR11 12" tubes
- **Tube pitch:** ~2.9" (7.4 cm) per tube
...
- Orange: Some consumer variants
- Natural/white: Some display tubes

### Fiberglass/FRE

**European standard:**
- ID closely matches shell size
- Wall thickness: 3-10mm depending on caliber
- Reinforced ends on larger tubes (7"+)
- Yellow or natural color typical

## Tube Spacing Formulas

### Consumer Racks (DR11)
```
Tube OD: 2.4" (6.1 cm)
Minimum separation: 0.5-1.0" (1.3-2.5 cm)
Center-to-center: 2.9-3.4" (7.4-8.6 cm)

6-shot rack length: 6 × 3" = 18"
12-shot rack length: 12 × 3" = 36"
```

### Display Racks (3-4 inch)
```
3" tube OD: 3.5" (8.9 cm)
Min separation: 2" (5.1 cm) [greater of 2" or 1.5"]
Center-to-center: 5.5" (14 cm)

8-tube rack length: 8 × 5.5" = 44" (112 cm)
```

### Display Racks (4-6 inch)
```
4" tube OD: 4.5" (11.4 cm)
Min separation: 2" (5.1 cm) [greater of 2" or 2"]
Center-to-center: 6.5" (16.5 cm)
...
- Wood rack frame (8-tube): ~15-20 lbs

## Common Rack Types by Application

### Backyard Consumer
- **5-6 shot:** Testing, small shows
- **12 shot straight:** Standard displays
- **24 shot V/W:** Finale racks

### Professional Small
- **3" × 8 tubes:** Metal bar rack
- **4" × 6 tubes:** Metal bar rack  
- **Mixed caliber boxes:** 3" + 4" combinations
...
### LOD0 (Hero/Close-up)
- Model individual tube separators
- Accurate tube OD/ID
- Visible plugs and fuses
- Base plate details

### LOD1 (Medium Distance)
- Simplified separators
- Combined tube geometry
...
### Collision Meshes
- Consumer rack: Box ~36" × 13" × 14" (L×W×H with tubes)
- Display rack: Box sized to actual dimensions + 6" height margin
